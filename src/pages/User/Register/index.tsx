...
import { FormattedMessage, history, SelectLang, useIntl, Helmet, Link } from '@umijs/max';
    ...
    <div className={containerClassName}>
      ...
      >
        <LoginForm
          ...
          actions={[
            <div style={{ fontSize: '14px', float: 'left' }} key="goLogin">
              <FormattedMessage
                id="pages.register.hasAccount"
              />
              <Link to="/user/login" style={{color: '#1677ff', fontSize: '14px'}}>
                <FormattedMessage
                  id="pages.register.goLogin"
                />
              </Link>
            </div>,
          ]}
              ...
              <ProFormText
                ...
                rules={[
                  ...
                  },
                  {
                    ...
                    message: (
                      <FormattedMessage
                        id="pages.register.mail.invalid"
                        defaultMessage="手机号格式错误！"
                      />
                    ),
                  },
                ...
                rules={[
                  {
                    ...
                    message: (
                      <FormattedMessage
                        id="pages.register.company.required"
