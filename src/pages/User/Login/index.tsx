    ...
    <div className={containerClassName}>
      ...
      >
        <LoginForm
          ...
          actions={[
            <div style={{ fontSize: '14px', float: 'left' }} key="goRegister">
              <FormattedMessage id="pages.login.noAccount" defaultMessage="没有账号？" />
              <Link to="/user/register" style={{ color: '#1677ff', fontSize: '14px' }}>
                <FormattedMessage id="pages.login.goRegister" defaultMessage="去注册" />
              </Link>
            </div>,
            <Link
              key={'resetPassword'}
              to="/user/resetPassword"
              style={{ color: '#1677ff', fontSize: '14px', float: 'right' }}
            >
